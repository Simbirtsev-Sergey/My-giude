...
### Сравниваем ветки
git diff <название_ветки1> <название_ветки2> - сравнение ветки1 с веткой2 

### Суффикс навигации
~N, где N - число.
С помощью этой записи можно обратиться к N-ому с конца коммиту.

### Слияние веток
* git merge <Название ветки> - выполнить слияние (merge - от англ. сливать, поглощать)
